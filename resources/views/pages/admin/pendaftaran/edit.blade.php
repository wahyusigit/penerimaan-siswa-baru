...
@section('htmlheader_title')
    {{ trans('Edit Data Pendaftaran') }}
@endsection
@section('main-content')
<form id="formPendaftaran" class="form-horizontal" action="{{ route('updatePendaftaranAdmin', $calonsiswa->no_pendf) }}" method="POST" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="fa fa-check" data-bv-feedbackicons-invalid="fa fa-close" data-bv-feedbackicons-validating="fa fa-refresh">
    {{ csrf_field() }}
