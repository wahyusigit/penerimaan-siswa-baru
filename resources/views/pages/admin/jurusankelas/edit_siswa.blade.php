...
@section('htmlheader_title')
    {{ trans('Edit Data Siswa') }}
@endsection
@section('main-content')
<form id="formPendaftaran" class="form-horizontal" action="{{ route('updateSiswaKelasAdmin', $siswa->no_pendf) }}" method="POST" data-bv-message="This value is not valid" data-bv-feedbackicons-valid="fa fa-check" data-bv-feedbackicons-invalid="fa fa-close" data-bv-feedbackicons-validating="fa fa-refresh">
    {{ csrf_field() }}
...
<div class="row">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-capitalize" name="nm_cln_siswa" required="required" value="{{ $siswa->nm_cln_siswa }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">NISN</label>
                            <div class="col-sm-5">
                                <input type="number" class="form-control" name="nisn" required="required" value="{{ $siswa->nisn }}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control text-capitalize" name="tmp_lahir" required="required" value="{{ $siswa->tmp_lahir }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Tanggal lahir</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control datepicker3" name="tgl_lahir" required="required"  value="{{ date_format(date_create($siswa->tgl_lahir), "d-m-Y") }}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="alamat_sekolah_asal" name="alamat" class="form-control" rows="5" required="required">{{ $siswa->alamat }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="kd_jurusan" required="required">
                                    @foreach($jurusans as $jurusan)
                                        @if($siswa->kd_jurusan === $jurusan->kd_jurusan)
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Nama Lengkap</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-capitalize" name="nm_ortu" required="required" value="{{ $siswa->nm_ortu }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Pekerjaan</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control text-capitalize" name="pkrj_ortu" required="required" value="{{ $siswa->pkrj_ortu }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Penghasilan</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="gaji_ortu" required="required" value="{{ $siswa->gaji_ortu }}">
                            </div>
                        </div>
                    </div>
                    <div class="box-footer">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control text-capitalize" name="sklh_asal" required="required" value="{{ $siswa->sklh_asal }}">
                            </div>
                        </div>
                    </div>
                    <div class="box-footer">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="email" required="required" value="{{ $siswa->user->email }}">
                            </div>
    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-body">
                <div class="pull-left">
                    <a href="{{ route('indexKelasAdmin', $siswa->kd_kelas) }}" class="btn btn-default btn-flat"><i class="fa fa-arrow-left"></i>Kembali</a>
                </div>
